...
- **Windows - 0.1.364:** [Download StoryTable for Windows](https://github.com/framedbyrandy/storytable-testers/releases/download/v0.1.364-beta/StoryTable-0.1.364-Windows-Setup.exe)
- **Mac with an Apple M-series chip - 0.1.400:** [Download StoryTable for Apple Silicon](https://github.com/framedbyrandy/storytable-testers/releases/download/v0.1.400-beta/StoryTable-0.1.400-macOS-Apple-Silicon.dmg)
...
- **User Manual - 0.1.400:** [Open the current StoryTable User Manual](manual/StoryTable-User-Manual.pdf)
