...
- **Windows - 0.1.159:** [Download StoryTable for Windows](https://github.com/framedbyrandy/storytable-testers/releases/download/v0.1.159-beta/StoryTable-0.1.159-Windows-Setup.exe)
- **Mac with an Apple M-series chip - 0.1.145:** [Download StoryTable for Apple Silicon](https://github.com/framedbyrandy/storytable-testers/releases/download/v0.1.145-beta/StoryTable-0.1.145-macOS-Apple-Silicon.dmg)
