...
- **Windows - 0.1.361:** [Download StoryTable for Windows](https://github.com/framedbyrandy/storytable-testers/releases/download/v0.1.361-beta/StoryTable-0.1.361-Windows-Setup.exe)
- **Mac with an Apple M-series chip - 0.1.336:** [Download StoryTable for Apple Silicon](https://github.com/framedbyrandy/storytable-testers/releases/download/v0.1.336-beta/StoryTable-0.1.336-macOS-Apple-Silicon.dmg)
...
- **User Manual - 0.1.361:** [Open the current StoryTable User Manual](manual/StoryTable-User-Manual.pdf)
