...
- **Windows - 0.1.362:** [Download StoryTable for Windows](https://github.com/framedbyrandy/storytable-testers/releases/download/v0.1.362-beta/StoryTable-0.1.362-Windows-Setup.exe)
...
- **User Manual - 0.1.362:** [Open the current StoryTable User Manual](manual/StoryTable-User-Manual.pdf)
