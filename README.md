...
- **Mac with an Apple M-series chip - 0.1.331:** [Download StoryTable for Apple Silicon](https://github.com/framedbyrandy/storytable-testers/releases/download/v0.1.331-beta/StoryTable-0.1.331-macOS-Apple-Silicon.dmg)
...
- **User Manual - 0.1.331:** [Open the current StoryTable User Manual](manual/StoryTable-User-Manual.pdf)
