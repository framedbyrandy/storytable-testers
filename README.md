...
- **Windows - 0.1.120:** [Download StoryTable for Windows](https://github.com/framedbyrandy/storytable-testers/releases/download/v0.1.120-beta/StoryTable-0.1.120-Windows-Setup.exe)
- **Mac with an Apple M-series chip - 0.1.104:** [Download StoryTable for Apple Silicon](https://github.com/framedbyrandy/storytable-testers/releases/download/v0.1.104-beta/StoryTable-0.1.104-macOS-Apple-Silicon.dmg)
